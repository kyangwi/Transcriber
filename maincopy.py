...
def main():
    ...
    # Text input options: file upload and text area
    text_upload_method = st.radio("File Input Method:", ("Audio", "Video","Youtube link"))

    # Language selection
    language = st.radio("Select the expected language of the audio:", ("English", "Spanish", "French", "German"))
    dic_language = {
        'English':'en',
        'Spanish':'sp',
        'French':'fr',
    ...
    if text_upload_method == "Audio":
        uploaded_file = st.file_uploader("Choose a text file:", type=['mp3', 'wav', 'm4a', 'ogg', 'flac', 'aac'])
